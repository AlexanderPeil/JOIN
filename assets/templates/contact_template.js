    ...
    return `
        <div id="contactForm" class="contact-form-overlay">
            ...
            <div class="contact-input-container margin-top">
                <div onclick="removeElementById('contactForm')" class="icon-top-right" title="close form">
    ...
    <form id="formTaskContainer" class="contact-form-overlay" onsubmit="addTask(); return false;">
        ...
        <div class="add-form-right">
            <div class="contact-input-container">
                <div onclick="removeElementById('formTaskContainer')" class="icon-top-right" title="close form">
                ...
                <div class="contact-form-buttons btn-centered">
                    <button type="button" onclick="removeElementById('formTaskContainer')" class="contact-cancel-btn" title="close form">
                        <p>Cancel</p>
